  ...
  return (
    <>
      ...
      <div className='w-full h-[35px] px-[25px] mt-[30px] flex items-center justify-between'>
        <div className='w-max h-full bg-pink-accent flex gap-[0px] justify-between items-center rounded-[8px] px-[10px] pr-[15px] cursor-pointer' onClick={() => router.push("/admin/addProduct")}>
