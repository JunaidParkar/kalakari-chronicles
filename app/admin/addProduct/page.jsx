            ...
            <div className='w-full h-[calc(100dvh-75px)] overflow-x-hidden overflow-y-auto px-[25px] pt-[30px]'>
                ...
                <form className='w-full mt-[30px]' onSubmit={submitData}>
                    ...
                    <div className='w-full mt-[20px] mb-[20px]'>
                        <button className='px-[20px] py-[15px] bg-pink-accent w-max rounded-[8px]' type='submit'><p className='text-white font-inter-regular text-[16px] leading-[24px]'>Upload the product.</p></button>
                    </div>
                </form>
            </div>
