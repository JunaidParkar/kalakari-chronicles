            ...
            <div className='bg-white drop-shadow-md w-[500px] px-[30px] py-[40px]'>
                ...
                <form className='w-full flex flex-col gap-[20px]'>
                  <div className='w-full flex flex-col gap-[10px]'>
                    <label htmlFor="" className='font-inter-medium text-[16px] leading-[24px]'>E-Mail</label>
                    <input type="email" className='w-full px-[15px] py-[10px] outline-0 border-2 rounded-[8px] border-white-border font-inter-regular text-[16px] leading-[24px]' placeholder='Enter your E-Mail' />
                  </div>
                  <div className='w-full flex flex-col gap-[10px]'>
                    <label htmlFor="" className='font-inter-medium text-[16px] leading-[24px]'>Password</label>
                    <input type="password" className='w-full px-[15px] py-[10px] outline-0 border-2 rounded-[8px] border-white-border font-inter-regular text-[16px] leading-[24px]' placeholder='Enter your password' />
                  </div>
